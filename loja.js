...
function comprarProduto(produtoId) {
  ...
  if (produtosColetivos.includes(produtoId)) {
    ...
    const faltaPara1000 = 1000 - investimentoAtual;

    if (faltaPara1000 <= 0) return alert("Este produto coletivo já foi comprado pela sala.");
    ...
    if (valorInvestido > faltaPara1000) {
